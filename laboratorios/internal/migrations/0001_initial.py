# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-06-29 18:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inventory_type', models.CharField(choices=[('SupplyInventory', 'Insumos'), ('EquipmentInventory', 'Equipos'), ('SampleInventory', 'Muestras')], default='SupplyInventory', max_length=50)),
                ('registered_date', models.DateTimeField(auto_now_add=True)),
            ],
            options={
                'abstract': False,
