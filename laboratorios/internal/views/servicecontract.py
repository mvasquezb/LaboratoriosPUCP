...
def delete(request, idServiceContract):

    servicecontract = get_object_or_404(ServiceContract, pk=idServiceContract)
    servicerequest = get_object_or_404(ServiceRequest, pk = servicecontract.servicerequest.pk)
...
def edit(request,
    ...
    state = ServiceRequestState.objects.get(slug="Modificado")
